...
class FileLoader {
  ...
  init(app) {
    ...
    this.config = ConfigValidator.start(app.config);
  }
  ...
  function methodToMiddleware(Controller, key) {
    return function classControllerMiddleware(...args) {
      ...
      if (Object.getPrototypeOf(Controller.prototype) === Object.prototype) {
        ...
        Reflect.set(controller, 'ctx', base.ctx);
        Reflect.set(controller, 'app', base.app);
        Reflect.set(controller, 'config', base.config);
        Reflect.set(controller, 'service', base.service);
      } else {
