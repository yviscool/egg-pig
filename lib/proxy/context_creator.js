...
class ContextCreator {
  ...
  create(controller, key, metadata, loadInstanceFnc) {
    ...
    const classMetadata = DecoratorManager.getMethodDataFromClass(metadata, controller);
    const methodMetadata = DecoratorManager.getMethodDataFromClass(DecoratorManager, controller, key);
    return [
