...
module.exports = {
  ...
  createCallbackProxy({ method, targetCallback }, controller) {
    ...
    const getsFeaturesInstance = this.getsFeaturesInstance.bind(this);
    ...
    const canTransformFn = this.createPipesFn(pipes, callbackParamtypes, paramTypes, getsFeaturesInstance, getCustomFactory);
