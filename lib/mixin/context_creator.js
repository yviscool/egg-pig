...
module.exports = {
  ...
  createFeatures(proto, key) {
    return [
      this.createGuards(proto, key),
      this.createPipes(proto, key),
      this.createInterceptors(proto, key),
      this.createFilters(proto, key),
    ];
  },
  ...
  loadInstanceForFilters(metatype) {
    ...
    if ((metatype.name || metatype.name === '') && !is.function(metatype.catch)) {
