...
const { PARAMTYPES_METADATA } = require('./constants');
...
//  extends
exports.getParamTypes = function getParamTypes(target, method) {
  return Reflect.getMetadata(PARAMTYPES_METADATA, target.prototype, method);
};

exports.defineMetadata = function defineMetadata(metadataKey, value, target) {
  return Reflect.defineMetadata(metadataKey, value, target);
};

exports.getMetadata = function getMetadata(metadataKey, target) {
