...
exports.createParamDecorator = function createParamDecorator(factory) {
  ...
  return createMapping(paramtype, factory);
};
...
exports.UploadedFileStream = createMapping(RouteParamTypes.FILESTREAM);
exports.UploadedFilesStream = createMapping(RouteParamTypes.FILESSTREAM);
